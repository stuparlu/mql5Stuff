//+------------------------------------------------------------------+
//|                                   EntryTwoLinesCrossTemplate.mq5 |
//|                                                           Parche |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
#property copyright "Parche"
...
//---
//---
   entryHandle = iCustom(_Symbol, PERIOD_CURRENT, "vortexIndi.ex5", 32);
...
#define ENTRY_FIRST_BUFF_INDEX 0
#define ENTRY_SECOND_BUFF_INDEX 1  
...
//---
   ...
   FillArraysFromBuffers(mainIndicator, signalIncicator, entryHandle, 2, ENTRY_FIRST_BUFF_INDEX, ENTRY_SECOND_BUFF_INDEX);
   string signal = "";  
